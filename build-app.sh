...
#build
../lazarus/share/lazarus/lazbuild -B -r --verbose --lazarusdir=/root/lazarus/share/lazarus --compiler=/root/fpc/ppcx64 freepascal-addition-section-manipulator/src/main/custapp..lpk
if [ $? -ne 0 ];
then 
  clearResoures
  exit 1;
