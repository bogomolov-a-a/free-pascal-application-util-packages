...
#build
../lazarus/share/lazarus/lazbuild -B -r --verbose --lazarusdir=/root/lazarus/share/lazarus --compiler=/root/fpc/ppcx64 --add-package pesp/src/main/pesp.lpk freepascal-addition-section-manipulator/src/main/custapp.addionalsectionmanipulator.lpk
if [ $? -ne 0 ];
then 
  clearResoures
  exit 1;
